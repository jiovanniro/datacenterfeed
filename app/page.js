  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <div className="border-b border-neutral-800 bg-neutral-900">
        <div className="max-w-7xl mx-auto px-2 md:px-6 py-2 md:py-3 flex items-center gap-2 md:gap-6">
          <button
          ...
          <div className="relative">
            ...
            {showSourcesDropdown && (
              <>
                ...
                />
                <div className="absolute top-full left-0 mt-2 w-64 bg-neutral-800 border border-neutral-700 rounded-lg shadow-xl z-50 py-2 max-h-96 overflow-y-auto">
          ...
          <div className="relative">
            ...
            {showGearDropdown && (
              <>
                ...
                />
                <div className="absolute top-full right-0 mt-2 w-56 bg-neutral-800 border border-neutral-700 rounded-lg shadow-xl z-50 py-2">
                  <button
